      ...
      >
        ...
        <div className="mb-3 flex -mx-2">
          <div className="px-2">
            ...
            <input
              type="radio"
              className={`${styles.form_radio} h-5 w-5 text-indigo-500`}
              name="type"
              id="type1"
              checked
            />
        ...
        <div className="mb-3 -mx-2 flex items-end">
          <div className="px-2 w-1/2">
            ...
            <div>
              <select
                className={`${styles.form_select} w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors cursor-pointer`}
              >
